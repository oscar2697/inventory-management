    ...
    return (
        <div className={sidebarClassNames}>
            <div className={`flex gap-3 justify-between md:justify-normal items-center pt-8 ${isSidebarCollapsed ? 'px-5' : 'px-8'}`}>
                <Image
                    src='https://s3.us-east-2.amazonaws.com/s3.inventory.management/logo.png'
                    alt="Stock Logo"
                    width={27}
                    height={27}
                ...
                <h1 className={`${isSidebarCollapsed ? 'hidden' : 'block'} font-extrabold text-2xl`}>OscarStock</h1>
            ...
            <div className={`${isSidebarCollapsed ? 'hidden' : 'block'} mb-10`}>
                <p className='text-center text-xs text-gray-500'>&copy; {new Date().getFullYear()} Oscar Lindo</p>
            </div>
        </div>
    )
}
